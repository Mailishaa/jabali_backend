...
class User(Base):
    ...
    community_forest_association_id = Column(UUID(as_uuid=True), ForeignKey("community_forest_associations.community_forest_association_id", use_alter=True, name="fk_users_cfa"), nullable=True)
