...
def initiate_registration_payment(
    ...
    return registration_payment_service.initiate_registration_payment(
        db,
        member_id,
        current_user
    )
...
def registration_payment_callback(
    ...
    return registration_payment_service.process_registration_payment(
        db,
        payload
    )
...
def get_registration_payment(
    ...
    return registration_payment_service.get_registration_payment(
        db,
        member_id
    )